...
import com.example.cleanmvvm.domian.use_case.coin_detail.GetCoinUseCase
...
class CoinDetailViewModel @Inject constructor(
    ...
    init {
        savedStateHandle.get<String>(Constants.PARAM_COIN_ID)?.let { coinId ->
            Log.i("CoinDetailViewModel", "coin - $coinId")
            getCoinById(coinId)
        }
    }

    private fun getCoinById(coinId: String) {
        Log.i("CoinDetailViewModel", "getCoinById - $coinId")
